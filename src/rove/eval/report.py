...
Run as a script (`python -m rove.eval.report`) once Kevin has
...
from rove.eval.labels import Label, LabelEntry
from rove.storage import read_json, write_json
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Rove — reporte de calidad de coincidencias")
    parser.add_argument(
        "--set-baseline",
        action="store_true",
